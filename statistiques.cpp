    ...
    ui(new Ui::statistiques)
{
    ...
    tous++;
    if (qry.value(0)=="12345622")
    {
        panne++;
    }
    else if(qry.value(0)!="12345622")
    {
        fonctionnel++;
    }
            }
...
QString pleaseworks= QString::number(testing2);
    series ->append("disponible "+pleasework+"%",(panne));
        series ->append("non disponible "+pleaseworks+"%",(fonctionnel));
...
slice1->setLabelVisible();
 ...
 slice1->setBrush(Qt::red);
    ...
    chart->setTitle("numbre des equipements  : ");
    chart->legend()->hide();
